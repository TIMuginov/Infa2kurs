...
public class Programm0 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (line != null) {
                System.out.printf("\n%-4d|%-57s|%-11s|%-11d|%14d|%14s|%14s\n", i, line, palindrome(line), line.length(), sizeOfBytes(line),Hartley(line), Shannon(line));// место этих цифр нужно вызывать методы Хартли и Шенон,но я не сделал.
                cherta();
                i++;
                line = reader.readLine();
            }
    ...
    public static double countUniqueCharacters(String s) {
        return s.chars().distinct().count();//power of alphabet

    }
        static double Hartley(String line) {
            double I = (Math.log(countUniqueCharacters(line)) / Math.log(2));
            return (int)(I);
        }
        ...
        static double Shannon(String line) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                shannon += p * Math.log10(p) / Math.log10(2);
            }
  ...
  /*  public static double Hartley(String s) {
